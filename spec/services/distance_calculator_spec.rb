...
RSpec.describe DistanceCalculator do
  ...
  describe "#call" do
    ...
    it "returns exactly 4 decimal places, not 3" do
      shop = [ CoffeeShop.new(id: 1, name: "Test", x: 1.23456, y: 0.0) ]
      result = described_class.new(shops: shop, x: 0, y: 0).call
